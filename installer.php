...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'TPVoyageBahia_1a2d3e1abbe6a1da7264_20221208151444_archive.zip';
        const ARCHIVE_SIZE       = '51344902';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1a2d3e1-08151444';
        const SECONDARY_PACKAGE_HASH = '710ada5-08151444';
        const VERSION            = '1.5.1';
